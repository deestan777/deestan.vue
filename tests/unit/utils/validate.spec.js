...
describe('Utils:validate', () => {
  ...
  it('validURL', () => {
    expect(validURL('https://github.com/deestan777/deestan.vue')).toBe(true);
    expect(validURL('http://github.com/deestan777/deestan.vue')).toBe(true);
    expect(validURL('github.com/deestan777/deestan.vue')).toBe(false)
  });
  it('validLowerCase', () => {
